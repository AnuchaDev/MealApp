...
const DUMMY_MEALS = const [
  ...
  Meal(
    ...
    complexity: Complexity.Simple,
    imageUrl:
        'https://ichef.bbci.co.uk/food/ic/food_16x9_1600/recipes/reallyeasymushroomri_70240_16x9.jpg',
    duration: 30,
    ingredients: [
      '1 Tbsp Olive Oil',
  ...
  Meal(
    ...
    title: 'Classic chocolate crepes',
    affordability: Affordability.Affordable,
    complexity: Complexity.Simple,
    imageUrl:
        'https://www.thespruceeats.com/thmb/_JKsT3UQrd3W1w_ypi7JBLqPwK0=/3120x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/crepes-with-chocolate-sauce-110856358-57c5e9ef3df78cc16ed8c5ed.jpg',
    duration: 20,
    ingredients: [
      '2 cups milk',
      '1 1/2 cups flour',
    ...
    steps: [
      'Sift flour into a bowl. Mix in sugar. Make a well in centre of dry ingredients.',
      'Combine in a bowl, milk and eggs to form a smooth batter (consistency of pouring cream). Whisk in chocolate. Gradually whisk in to dry ingredients.',
      'Heat a small frying pan or crepe pan on medium. Brush with a little butter. Pour batter into pan, swirling to cover base. Cook for 1-2 minutes. Turn over and cook for 30 seconds.',
      'Transfer to a plate. Continue with remaining batter, brushing pan with butter as required.',
      'Serve crepes folded and topped with cream, berries, grated chocolate and chocolate sauce, if desired.'
    ],
    isGlutenFree: true,
    isVegan: false,
    isVegetarian: true,
  ...
  Meal(
    ...
    complexity: Complexity.Simple,
    imageUrl:
        'https://images.unsplash.com/photo-1546964124-0cce460f38ef?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1500&q=80',
    duration: 30,
    ingredients: [
